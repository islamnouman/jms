        ...
        <div class="col-md-8">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                        ...
                        <form method="post" action="<?php echo e(route('task.store')); ?>" >
                            ...
                            <button type="submit" class="btn btn-primary btn-success">Save it</button>
                        </form>
                </div>
            </div>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        <th scope="row">1</th>
                        <td><h6 class="card-title"><?php echo e(__('Titel')); ?></h6></td>
                        <td><p class="card-text"><?php echo e(__('Detail of Task')); ?></p></td>
                        <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Tasker\resources\views/task.blade.php ENDPATH**/ ?>